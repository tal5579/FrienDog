...
class SignUpScreen extends Component {
  ...
  CheckingDetails = (email ,password ,confirmPass,userDogName,breed,gender) => {
    if( email == '' || password =='' || confirmPass == '' || userDogName == '' || gender == '' || breed == '')
    {
      ...
      <View>
            ...
            <RadioForm
              ...
              <TouchableOpacity style={styles.buttonContainer}
                onPress = {() =>  {this.CheckingDetails(this.state.email ,this.state.password,this.state.confirmPass,this.state.userDogName,this.state.gender,this.state.breed)}}  >
